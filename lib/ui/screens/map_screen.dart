...
class _MapScreenState extends State<MapScreen> {
    ...
    try {
      ...
      if (locationData.latitude != null && locationData.longitude != null) {
        setState(() {
          ...
          _addMarker(_userLocation!, "Your Location", BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure));
        });
        _updateCamera();
  ...
  void _simulateDriverUpdates() {
    ...
    _driverLocation = LatLng(_userLocation!.latitude - 0.01, _userLocation!.longitude - 0.01);
    _addMarker(_driverLocation!, "Driver", BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueGreen));
    _getRouteToUser();
      ...
      if (_userLocation != null && _driverLocation != null) {
        setState(() {
          _driverLocation = LatLng(
            _driverLocation!.latitude + (_userLocation!.latitude - _driverLocation!.latitude) * 0.1,
            _driverLocation!.longitude + (_userLocation!.longitude - _driverLocation!.longitude) * 0.1,
          );
          _updateDriverMarker();
          _getRouteToUser();
        });
  ...
  Future<void> _updateCamera() async {
    ...
    LatLngBounds bounds = LatLngBounds(
      southwest: LatLng(
        _userLocation!.latitude < _driverLocation!.latitude ? _userLocation!.latitude : _driverLocation!.latitude,
        _userLocation!.longitude < _driverLocation!.longitude ? _userLocation!.longitude : _driverLocation!.longitude,
      ),
      northeast: LatLng(
        _userLocation!.latitude > _driverLocation!.latitude ? _userLocation!.latitude : _driverLocation!.latitude,
        _userLocation!.longitude > _driverLocation!.longitude ? _userLocation!.longitude : _driverLocation!.longitude,
